...
<div className="flex justify-center">
        <div className="grid">
      <h1 className="font-inter font-semibold font-size[18px] text-primary text-2xl flex justify-center mb-2">BỮA ĂN ĐẶC TRƯNG</h1>
...
vùng miền</h1>
      ...
      <div className="w-full bg-[#f6e4dc] md:h-[412px] sm:h-[400px] h-[650px] mt-10 mb-80 relative">
