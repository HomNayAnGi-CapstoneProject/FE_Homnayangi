        ...
        <div className="sm:flex justify-center gap-[60px]">
          <div className="flex-col px-[16px] font-inter">
            ...
            <div className="w-full">
              ...
              <p className="text-[16px] sm:w-[500px] sm:px-0 w-550 leading-[30px] py-5 text-justify">
        ...
        <div className={`sm:flex py-20 gap-[60px] justify-center px-[0px] `}>
          ...
          <div className="font-inter px-[16px] ">
            ...
            <div className="sm:w-[642px] w-550">
              <p className="text-[16px] leading-[30px] text-justify">
              ...
              <p className="text-[16px] leading-[30px] py-5 text-justify">
